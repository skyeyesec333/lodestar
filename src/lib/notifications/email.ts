...
<html>
  ...
  <body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 32px 24px;">
    ...
    <p style="font-size: 15px; line-height: 1.6;">
      The LOI target date for <strong>${params.projectName}</strong> was
...
<html>
  <body style="font-family: Georgia, serif; color: #1a1a1a; max-width: 600px; margin: 0 auto; padding: 32px 24px;">
    ...
    <p>Expert: ${params.expertName} (${params.expertId})</p>
    <p>Requested by: ${params.userId}</p>
    <p>Context: ${params.context}</p>
    <p>Timing: ${params.timing}</p>
  </body>
</html>
  `.trim();
