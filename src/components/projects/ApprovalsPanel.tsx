...
> = {
  ...
  in_review: {
    ...
    bg: "color-mix(in srgb, var(--status-review) 10%, var(--bg-card))",
    border: "color-mix(in srgb, var(--status-review) 30%, var(--border))",
    dot: "var(--status-review)",
  },
  approved: {
    label: "Approved",
    color: "var(--status-ok)",
    bg: "color-mix(in srgb, var(--status-ok) 10%, var(--bg-card))",
    border: "color-mix(in srgb, var(--status-ok) 30%, var(--border))",
    dot: "var(--status-ok)",
  },
  rejected: {
    label: "Rejected",
    color: "var(--status-reject)",
    bg: "color-mix(in srgb, var(--status-reject) 10%, var(--bg-card))",
    border: "color-mix(in srgb, var(--status-reject) 30%, var(--border))",
    dot: "var(--status-reject)",
  },
};
